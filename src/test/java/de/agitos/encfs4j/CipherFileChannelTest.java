...
public class CipherFileChannelTest {
	...
	private static SecretKeySpec secretKeySpec = new SecretKeySpec(
			"gP1;5otOHqd#kuci".getBytes(), "AES");
	...
	@Test
	public void test1ReverseWrite() throws IOException,
		...
		CipherFileChannel fc = new CipherFileChannel(Paths.get(persistentFile
				...
				Paths.get(persistentFile.getParent()), true);

		ByteBuffer buf = ByteBuffer.allocate(testStringLength);
		/*
		 * fc.read(buf); fc.position(0); buf.clear();
		 */
